...
dev.new(width=8, height=4, noRStudioGD = T, dpi=80, pointsize=14)
par(mfrow=c(1,2), mar=c(4,4,0,0))
plot(sum_dat$fire_cat, sum_dat$sr_25)
plot(sum_dat$fire_cat, sum_dat$sr_5)
...
title(mgp=c(2.3,0.8,0),xlab="Fire Category")
m8.tab2
text(1.9,max(m8_c.pr2$uci),as.expression(bquote(Delta~"AICc ="~.(paste(round(m8.tab2$Delta_AICc[m8.tab2$Modnames=="fire"]-m1.tab2$Delta_AICc[m8.tab2$Modnames=="null"],2),sep="")))),adj=0,col="red", cex=0.9)
mtext(text="(a)", side = 3, line = 0.5, adj = 0, cex = 1)
...
title(mgp=c(2.3,0.8,0),xlab="Fire Category")
m7.tab2
text(1.9,max(m7_c.pr2$uci),as.expression(bquote(Delta~"AICc ="~.(paste(round(m7.tab2$Delta_AICc[m7.tab2$Modnames=="fire"]-m7.tab2$Delta_AICc[m7.tab2$Modnames=="null"],2),sep="")))),adj=0,col="red", cex=0.9)
mtext(text="(b)", side = 3, line = 0.5, adj = 0, cex = 1)
...
title(mgp=c(2.3,0.8,0),xlab="Fire Category")
text(1.9,max(m4_c.pr2$uci),as.expression(bquote(Delta~"AICc ="~.(paste(round(m4.tab2$Delta_AICc[m4.tab2$Modnames=="fire"]-m4.tab2$Delta_AICc[m4.tab2$Modnames=="null"],2),sep="")))),adj=0,col="red", cex=0.9)
mtext(text="(c)", side = 3, line = 0.5, adj = 0, cex = 1)
...
title(mgp=c(2.3,0.8,0),xlab="Fire Category")
text(1.9,max(m3_b.pr2$uci),as.expression(bquote(Delta~"AICc ="~.(paste(round(m3.tab2$Delta_AICc[m3.tab2$Modnames=="fire"]-m3.tab2$Delta_AICc[m3.tab2$Modnames=="null"],2),sep="")))),adj=0,col="red", cex=0.9)
mtext(text="(d)", side = 3, line = 0.5, adj = 0, cex = 1)
